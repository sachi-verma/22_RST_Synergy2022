$(document).ready(function () {
  ...
  // GLOBAL VARIABLES
  var img, canvas, container, imgRatio, containerRatio;
  ...
  function widowControl() {
    ...
    var widowElements = $(
      "h1, h2, h3, h4, h5, h6, li, p, figcaption, .case-study-tagline, .large-cta"
  ...
  function initialLoader() {
    ...
    var loadText = "PRINT ('CRESCENDO 2023')";
  ...
  function initializeGlitch(image, height) {
    ...
    var mesh, light, dotEffect, shiftEffect, sepiaEffect;

    var glitchDtSize = 100,
      glitchDelay = 1,
      glitchAmplification = 0.5;
    ...
    function init() {
      ...
      composer1 = new THREE.EffectComposer(
        renderer,
        new THREE.WebGLRenderTarget(SCREEN_WIDTH, SCREEN_HEIGHT, rtParameters)
      );
  ...
  function loadPageStatic() {
    $("body").prepend(
      '<div id="initial-loader" class="padded" style="opacity: 0;"><span id="loader-text"></span></div>'
    );
